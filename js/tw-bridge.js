(function () {
  ...
  // Notes overview layout (Maths Week 1)
  ...
  // Stats for DS specific structures
  ...
  // Enhance learning objective bullets with an icon
  try {
  ...
  // Legacy topic pages (topic4–10) layout polish
